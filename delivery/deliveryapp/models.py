...
class OrderDetail(ModelBase):
    ...
    phone_cus = models.ForeignKey(Customer, null=True, on_delete=models.CASCADE())
    phone_shipper = models.ForeignKey(Shipper, null=True, on_delete=models.CASCADE())
...
class Rating(ActionBase):
    ...
    shipper = models.ForeignKey(Shipper, null=False, on_delete=models.SET_NULL())
    star = models.CharField(max_length=5, null=False)
    comment = models.TextField()


class AuctionHistory(models.Model):
    shipper = models.ForeignKey(User, null=True, on_delete=models.SET_NULL())
